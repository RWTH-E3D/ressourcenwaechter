...
// ==== VOC: SGP40 ====
#define I2C_SGP40                     0x59   // I2C, it has only one I2C address, default address hardcoded in Adafruit library (not used in setup)

// ==== light: VEML7700 ====
#define I2C_VEML7700                  0x10   // I2C, it has only one I2C address, default address hardcoded in Adafruit library (not used in setup)

// ==== CO2: SCD30 ====
#define I2C_SCD30                     0x61   // I2C, it has only one I2C address, default address hardcoded in Adafruit library (not used in setup)

// ==== CO2: SCD40/41 ====
#define I2C_SCD40                     0x62   // I2C, SCD4x (40 or 41) uses fixed address 0x62
